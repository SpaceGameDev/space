...
public class ModelBunny {
	...
	public static float[] bunny(int res, Matrix4f scale) throws IOException {
		byte[] bytes = ModelBunny.class.getResourceAsStream("bun_zipper" + (res == 0 ? "" : "_res" + res) + ".ply").readAllBytes();
